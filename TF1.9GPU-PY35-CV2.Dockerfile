...
#sudo docker build -f ./TF1.9GPU-PY35-CV2.Dockerfile -t k2vision/tf19gpu_py35_cv2:v1.0 .
#sudo docker run -it -p 5000:5000 -v /gw_detect_app:/gw_detect_app tf19cpu_py35_cv2:v1.0 /bin/bash python3 /gw_detect_app/app.py